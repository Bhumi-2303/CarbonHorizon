...
function reductionColor(pct: number) {
  if (pct >= 30) return { text: 'text-earth-green', bg: 'bg-earth-green/15', ring: 'ring-earth-green/30' }
...
function ToggleCard({
  ...
  return (
    ...
    >
      ...
      {/* Expanded knobs */}
      {active && children && (
        <div className="px-4 pb-4 pt-0 border-t border-earth-green/20 animate-fade-in">
          {children}
        </div>
      )}
    </div>
  ...
  return (
    <div className="mt-3">
      <div className="flex justify-between items-center mb-1">
        ...
        <span className="text-xs font-semibold text-earth-green tabular-nums">
          {value}{unit}
        </span>
      </div>
      <input
...
function ResultsPlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center h-64 gap-4 text-center">
      ...
      <div>
        <p className="text-sm font-medium text-muted">No results yet</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 p-4 sm:p-6 lg:p-8">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-80 h-80 rounded-full bg-earth-green/20 blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-deep-ocean/50 border border-slate-700/50 rounded-2xl p-5">
              ...
              >
                <div className="mt-3">
                  <p className="text-xs text-muted mb-2">New mode</p>
                ...
                <div className="space-y-5 animate-fade-in">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-deep-ocean/50 border border-slate-700/40 rounded-xl p-3 text-center">
                      ...
                      <p className="text-xs text-muted mt-0.5">kg saved/mo</p>
                    </div>
                    ...
                    <div className="bg-deep-ocean/50 border border-slate-700/40 rounded-xl p-3 text-center">
                      ...
                      <p className="text-xs text-muted mt-0.5">kg/year est.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 pt-1">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl
                        ...
                        bg-earth-green/15 border border-earth-green/30 text-emerald-300
                        hover:bg-earth-green/25 hover:border-earth-green/50"
                    >
                      {saving ? (
