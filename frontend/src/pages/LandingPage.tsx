      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="max-w-2xl">
            ...
            <p className="body text-slate-300 text-lg mb-8 leading-relaxed">
            ...
            <div className="absolute top-10 right-0 glass-card p-4 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-white">450 kg CO₂</p>
                </div>
              </div>
            </div>
            <div className="absolute bottom-10 left-0 glass-card p-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-white">3 new insights</p>
                </div>
              </div>
            </div>
          </div>
...
function About() {
  return (
    <section id="about" className="py-20 bg-deep-ocean/30 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="heading-lg text-white mb-6">What is a Carbon Footprint?</h2>
        <p className="body text-slate-300 leading-relaxed mb-8">
    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="heading-lg text-white mb-4">Built for Everyone</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {AUDIENCES.map((aud, i) => (
            <div key={i} className="glass-card p-6 text-center hover:-translate-y-1 transition-transform duration-300">
              ...
              <h3 className="font-poppins font-semibold text-white mb-2">{aud.title}</h3>
...
function HowItWorks() {
  return (
    <section className="py-24 bg-deep-ocean/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="heading-lg text-white text-center mb-16">How It Works</h2>
...
function CoreFeatures() {
  return (
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="heading-lg text-white text-center mb-16">Core Features</h2>
  ...
  return (
    <section className="py-24 bg-deep-ocean/30">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="heading-lg text-white text-center mb-12">Frequently Asked Questions</h2>
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            <div key={i} className="glass-card overflow-hidden transition-all duration-200">
              ...
              {openIdx === i && (
                <div id={`faq-answer-${i}`} className="px-6 pb-6 text-slate-300">
                  {faq.a}
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-poppins font-bold text-xl text-white">Carbon Horizon</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-white mb-4">Legal & Connect</h4>
            <ul className="space-y-2">
              ...
              <li className="pt-2 flex gap-4">
                <a href="#" className="text-slate-400 hover:text-white"><Code className="w-5 h-5" aria-hidden="true" /></a>
                <a href="#" className="text-slate-400 hover:text-white"><Mail className="w-5 h-5" aria-hidden="true" /></a>
              </li>
            </ul>
          </div>
        </div>
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-bg-primary font-sans text-slate-300 selection:bg-earth-green/30">
      <Header />
      <main>
        <Hero />
        <About />
