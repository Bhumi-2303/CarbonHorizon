  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] max-w-2xl mx-auto px-4">
      ...
      <div className="glass-card w-full p-8 text-center animate-fade-shift-up">
        {step === 1 && (
          <div>
            <h2 className="text-2xl font-bold text-primary mb-8">How did you get around today?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Walk / Bike</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">School Bus</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Car</span>
              </button>
            </div>
          </div>
        )}
        ...
        {step === 2 && (
          <div>
            <h2 className="text-2xl font-bold text-primary mb-8">Did you turn off the lights when leaving a room?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Yes, I remembered!</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Oops, I forgot</span>
              </button>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div>
            <h2 className="text-2xl font-bold text-primary mb-8">What did you drink from today?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">My Reusable Bottle</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">A Plastic Bottle</span>
              </button>
            </div>
          </div>
        )}
        ...
        {step === 4 && (
          <div>
            <h2 className="text-2xl font-bold text-primary mb-8">What kind of food did you eat mostly?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Fruits & Veggies</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Meat & Dairy</span>
              </button>
            </div>
          </div>
        )}
        ...
        {step === 5 && (
          <div>
            <h2 className="text-2xl font-bold text-primary mb-8">Did you recycle any paper or plastic today?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Yes!</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-xl font-semibold text-primary">Not today</span>
              </button>
            </div>
            ...
            {answers.recycle && (
              <button 
                ...
                disabled={submitting}
                className="w-full py-4 bg-gradient-to-r from-earth-green to-forest-green hover:from-emerald-500 hover:to-emerald-600 text-primary rounded-xl text-xl font-bold transition-all shadow-lg hover:shadow-emerald-500/25 disabled:opacity-50"
              >
