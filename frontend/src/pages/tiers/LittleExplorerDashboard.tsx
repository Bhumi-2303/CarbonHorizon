    ...
    <div className="flex flex-col gap-8 pb-12 animate-fade-shift-up">
      ...
      <div className="glass-card p-6 md:p-8 flex flex-col md:flex-row items-center gap-8 justify-between relative overflow-hidden border-emerald-500/20">
        ...
        <div className="flex-1 text-center md:text-left z-10">
          <h1 className="text-4xl font-black text-white mb-2 font-poppins">{title}</h1>
        ...
        <div className="relative flex items-center justify-center z-10 bg-slate-900/50 rounded-full p-4">
          ...
          <div className="absolute flex flex-col items-center justify-center">
            <span className="text-4xl font-black text-white font-poppins">{score}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="glass-card p-6 border-sky-500/20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-white font-poppins">Today's Nature Mission</h2>
          </div>
        ...
        <div className="glass-card p-6 border-emerald-500/20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-white font-poppins">My Green Actions</h2>
          </div>
          <div className="space-y-3">
            <button onClick={() => toggleAction('water')} className={`w-full text-left flex items-center gap-4 p-4 rounded-xl border transition-all ${actions.water ? 'bg-emerald-400/10 border-emerald-400/30' : 'bg-slate-800/50 border-slate-700 hover:border-slate-500'}`}>
              ...
              <span className={`text-lg font-medium ${actions.water ? 'text-white' : 'text-slate-300'}`}>I saved water today</span>
            </button>
            <button onClick={() => toggleAction('lights')} className={`w-full text-left flex items-center gap-4 p-4 rounded-xl border transition-all ${actions.lights ? 'bg-amber-400/10 border-amber-400/30' : 'bg-slate-800/50 border-slate-700 hover:border-slate-500'}`}>
              ...
              <span className={`text-lg font-medium ${actions.lights ? 'text-white' : 'text-slate-300'}`}>I saved electricity today</span>
            </button>
            <button onClick={() => toggleAction('snack')} className={`w-full text-left flex items-center gap-4 p-4 rounded-xl border transition-all ${actions.snack ? 'bg-rose-400/10 border-rose-400/30' : 'bg-slate-800/50 border-slate-700 hover:border-slate-500'}`}>
              ...
              <span className={`text-lg font-medium ${actions.snack ? 'text-white' : 'text-slate-300'}`}>I ate all my healthy snack</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="glass-card p-6 border-purple-500/20">
        <h2 className="text-2xl font-bold text-white font-poppins mb-6 flex items-center gap-3">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 snap-x">
          <div className="min-w-[250px] bg-gradient-to-br from-emerald-900/50 to-slate-900 p-6 rounded-2xl border border-emerald-500/30 snap-start">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Planet Protector</h3>
          ...
          <div className="min-w-[250px] bg-gradient-to-br from-sky-900/50 to-slate-900 p-6 rounded-2xl border border-sky-500/30 snap-start">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Green Explorer</h3>
          ...
          <div className="min-w-[250px] bg-gradient-to-br from-teal-900/50 to-slate-900 p-6 rounded-2xl border border-teal-500/30 snap-start">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Earth Helper</h3>
          ...
          <div className="min-w-[250px] bg-gradient-to-br from-amber-900/50 to-slate-900 p-6 rounded-2xl border border-amber-500/30 snap-start">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Nature Friend</h3>
      ...
      <div className="glass-card p-6 border-amber-500/20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-4">
          <div className={`flex flex-col items-center text-center p-4 rounded-xl ${score >= 10 ? 'bg-amber-400/20 border border-amber-400/50' : 'bg-slate-800/30 opacity-50 border border-slate-700'}`}>
            <Sun className={`w-10 h-10 mb-2 ${score >= 10 ? 'text-amber-400' : 'text-slate-500'}`} />
            <span className="text-sm font-bold text-slate-200">First Step</span>
          </div>
          <div className={`flex flex-col items-center text-center p-4 rounded-xl ${score >= 20 ? 'bg-sky-400/20 border border-sky-400/50' : 'bg-slate-800/30 opacity-50 border border-slate-700'}`}>
            <Droplet className={`w-10 h-10 mb-2 ${score >= 20 ? 'text-sky-400' : 'text-slate-500'}`} />
            <span className="text-sm font-bold text-slate-200">Water Saver</span>
          </div>
          <div className={`flex flex-col items-center text-center p-4 rounded-xl ${score >= 40 ? 'bg-emerald-400/20 border border-emerald-400/50' : 'bg-slate-800/30 opacity-50 border border-slate-700'}`}>
            <Leaf className={`w-10 h-10 mb-2 ${score >= 40 ? 'text-emerald-400' : 'text-slate-500'}`} />
            <span className="text-sm font-bold text-slate-200">Tree Hugger</span>
          </div>
          <div className={`flex flex-col items-center text-center p-4 rounded-xl ${score >= 60 ? 'bg-rose-400/20 border border-rose-400/50' : 'bg-slate-800/30 opacity-50 border border-slate-700'}`}>
            <Flame className={`w-10 h-10 mb-2 ${score >= 60 ? 'text-rose-400' : 'text-slate-500'}`} />
            <span className="text-sm font-bold text-slate-200">Energy Hero</span>
          </div>
          <div className={`flex flex-col items-center text-center p-4 rounded-xl ${score >= 75 ? 'bg-purple-400/20 border border-purple-400/50' : 'bg-slate-800/30 opacity-50 border border-slate-700'}`}>
            <Wind className={`w-10 h-10 mb-2 ${score >= 75 ? 'text-purple-400' : 'text-slate-500'}`} />
            <span className="text-sm font-bold text-slate-200">Sky Cleaner</span>
          </div>
          <div className={`flex flex-col items-center text-center p-4 rounded-xl ${score >= 90 ? 'bg-teal-400/20 border border-teal-400/50' : 'bg-slate-800/30 opacity-50 border border-slate-700'}`}>
            <TreePine className={`w-10 h-10 mb-2 ${score >= 90 ? 'text-teal-400' : 'text-slate-500'}`} />
            <span className="text-sm font-bold text-slate-200">Forest Friend</span>
          </div>
          <div className={`flex flex-col items-center text-center p-4 rounded-xl ${score >= 95 ? 'bg-amber-400/20 border border-amber-400/50 shadow-lg shadow-amber-400/20' : 'bg-slate-800/30 opacity-50 border border-slate-700'}`}>
            <Award className={`w-10 h-10 mb-2 ${score >= 95 ? 'text-amber-400' : 'text-slate-500'}`} />
            <span className="text-sm font-bold text-slate-200">Earth Champion</span>
          </div>
        </div>
      </div>
    </div>
