  ...
  return (
    <div className="flex flex-col h-[calc(100vh-160px)] max-w-3xl mx-auto glass-card border-sky-500/20 overflow-hidden">
      ...
      <div className="p-4 border-b border-sky-500/20 bg-sky-900/20 flex items-center gap-4">
        ...
        <div>
          <h2 className="text-xl font-black text-white font-poppins">Nature Guide</h2>
      ...
      <div className="p-4 border-t border-slate-700/50 bg-slate-900/50">
        <div className="relative">
          <input
            ...
            className="w-full bg-[#08121E] border border-slate-700 rounded-xl pl-4 pr-14 py-4 text-white text-lg focus:outline-none focus:border-sky-500 transition-colors"
            disabled={loading}
          />
          <button
            onClick={handleSend}
            disabled={!input.trim() || loading}
            className="absolute right-2 top-2 bottom-2 aspect-square bg-sky-500 hover:bg-sky-400 text-white rounded-lg flex items-center justify-center disabled:opacity-50 transition-colors"
          >
